# 🏆 Kemajuan & Ruang Lingkup Progresi (MC 26.2)
...
Karena mode vakum standar maupun [[Mode Pengambilan Instan|id_id-26.2-Instant-Pickup-Mode]] memanfaatkan pipa koleksi bawaan `ItemEntity.playerTouch()` dan `ExperienceOrb.playerTouch()` milik Minecraft:
...
2. **Kompatibilitas Quest Pihak Ketiga**: Mod quest (seperti FTB Quests atau Better Questing) yang melacak pengambilan item dalam inventaris pemain berfungsi secara langsung tanpa perlu jembatan kompatibilitas khusus.
