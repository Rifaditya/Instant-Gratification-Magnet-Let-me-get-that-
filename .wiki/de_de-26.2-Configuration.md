# 🎨 YACL-Konfigurations-GUI & ModMenu (MC 26.2)
...
| **GUI-Bibliothek** | YetAnotherConfigLib v3 (`dev.isxander:yet-another-config-lib`) |
| **ModMenu-Einstiegspunkt** | `net.instantgratification.magnet.config.ModMenuIntegration` |
| **GUI-Screen-Helfer** | `net.instantgratification.magnet.config.YaclScreenHelper` |
| **Classloading-Sicherheit** | Isoliert über `GuiHelper.getOptionalFactory` |

---

## 📖 Konfigurationssystem-Architektur

**Magnet, Let me get that!** bietet eine optionale clientseitige Konfigurations-Benutzeroberfläche, die von **YetAnotherConfigLib v3 (YACL)** angetrieben wird und über **ModMenu** zugänglich ist.

Um sicherzustellen, dass dedizierte Server beim Laden von Client-GUI-Klassen niemals abstürzen, wird die GUI-Factory über **reflexionssicheres isoliertes Classloading** aufgelöst:
...
> Um die Einstellungen einer aktiven, bereits existierenden Welt anzupassen, nutze die In-Game-[[GameRules-Referenz|de_de-26.2-GameRules]] via `/gamerule` oder den Vanilla-Spielregeln-Bearbeitungsbildschirm.

---

## 🗂️ Konfigurationskategorien & Optionen

```
YACL-Konfigurationsbildschirm ("Magnet, Let me get that! Configuration")
