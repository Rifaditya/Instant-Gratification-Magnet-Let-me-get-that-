...
Because both standard vacuum flight and [[Instant Pickup Mode|26.1.2-Instant-Pickup-Mode]] utilize Minecraft's native `ItemEntity.playerTouch()` and `ExperienceOrb.playerTouch()` collection pipelines:
...
* [[Instant Pickup Mode|26.1.2-Instant-Pickup-Mode]]
* [[GameRules Complete Reference|26.1.2-GameRules]]
