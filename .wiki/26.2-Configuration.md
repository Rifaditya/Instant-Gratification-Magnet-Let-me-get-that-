...
> To modify the settings of an active, already-created world, use the in-game [[GameRules Reference|26.2-GameRules]] via `/gamerule` or the vanilla GameRules edit screen.
