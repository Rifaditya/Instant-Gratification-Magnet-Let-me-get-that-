# 🏆 Progresos y Alcance de Progresión (MC 26.1.2)
...
Debido a que tanto el vuelo estándar de aspiración como el [[Modo de Recogida Instantánea|es_es-26.1.2-Instant-Pickup-Mode]] utilizan los canales de recolección nativos de Minecraft `ItemEntity.playerTouch()` y `ExperienceOrb.playerTouch()`:
...
2. **Compatibilidad con Mods de Misiones de Terceros**: Los mods de misiones que rastrean la recolección de objetos en los inventarios funcionan sin necesidad de puentes o parches adicionales.
