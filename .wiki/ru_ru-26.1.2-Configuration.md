# 🎨 Графический интерфейс Cloth Config и ModMenu (MC 26.1.2)
...
| **Библиотека GUI** | Cloth Config Fabric (`me.shedaniel.cloth:cloth-config-fabric:26.1.154`) |
| **Точка входа ModMenu** | `net.instantgratification.magnet.config.ModMenuIntegration` |
| **Хелпер экрана GUI** | `net.instantgratification.magnet.config.ClothConfigScreenHelper` |
...
В Minecraft 26.1.2 **Magnet, Let me get that!** интегрируется с **Cloth Config Fabric** и **ModMenu**, предоставляя внутриигровой графический экран настроек.
...
> Чтобы изменить настройки в активном, уже созданном мире, используйте внутриигровые команды [[Справочник GameRules и стандартные границы|ru_ru-26.1.2-GameRules]] через `/gamerule` или экран настройки правил игры.

---

## 🗂️ Категории и параметры

```
Экран конфигурации Cloth Config ("Настройки Magnet, Let me get that!")
