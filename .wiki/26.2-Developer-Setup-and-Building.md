...
The MC 26.2 `build.gradle` script features a registered `archiveReleaseJar` lifecycle task:
...
Upon successful compilation, the built JAR (`Magnet-Let-me-get-that-1.3.9+26.2.jar`) is automatically mirrored to `Archive Jar of all versions/MC 26.2/` and deployed to active local Modrinth launcher test directories.

---

## 🔗 Related Wiki Documentation
* [[Architecture & Mixin Implementations|26.2-Architecture-and-Mixins]]
* [[API & Addon Integration|26.2-API-and-Addon-Integration]]
