...
The MC 26.1.2 `build.gradle` script features an automated `archiveReleaseJar` lifecycle task:
...
* [[Architecture & Mixin Implementations|26.1.2-Architecture-and-Mixins]]
* [[API & Addon Integration|26.1.2-API-and-Addon-Integration]]
