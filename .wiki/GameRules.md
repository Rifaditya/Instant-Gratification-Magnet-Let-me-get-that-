...
> Settings in the client/server JSON configuration file (`config/ig_magnet.json`) only establish the **baseline default values for NEW worlds**. Active worlds are controlled strictly by GameRules.
