# 🏆 Fortschritte & Progressionsumfang (MC 26.1.2)
...
Da sowohl der Standard-Vakuumflug als auch der [[Sofort-Aufnahme-Modus|de_de-26.1.2-Instant-Pickup-Mode]] die nativen Sammel-Pipelines `ItemEntity.playerTouch()` und `ExperienceOrb.playerTouch()` von Minecraft nutzen:
